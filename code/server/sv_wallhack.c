...
static void
randomize_position( sharedEntity_t *anchor, sharedEntity_t *object ) {
	vec3_t los;
...
static int
can_see( sharedEntity_t *pent, sharedEntity_t*oent, playerState_t *ps ) {
...
int
AWH_CanSee( int player, int other ) {
...
int
AWH_CanHear( int player, int other ) {
	sharedEntity_t *pent, *oent;
	vec3_t dist;
...
void
AWH_RandomizePos( int player, int other ) {
	int i;
	sharedEntity_t *pent, *oent;
	playerState_t *ps;
	vec3_t pos;
